    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            { Name = "Екатерина", SurName = "Петрова", DateOfBirth = new DateTime(1952, 09, 20), 
                Gender = Gender.Female, Father = familyMember12, Mother= familyMember11
            ...
            { Name = "Владимир", SurName = "Петров", DateOfBirth = new DateTime(1950, 05, 17), 
                Gender = Gender.Male, Father=familyMember10, Mother=familyMember9 };//дедушка по линии матери
            ...
            { Name = "Мария", SurName = "Иванова", DateOfBirth = new DateTime(1992, 07, 25), 
            ...
            { Name = "Алексей", SurName = "Иванов", DateOfBirth = new DateTime(2020, 08, 05), 
                Gender=Gender.Male, Mother=familyMember2, Father=familyMember1 };//сын
            var familyMember4 = new FamilyMember()
            { Name = "Мария", SurName = "Иванова", DateOfBirth = new DateTime(2018, 03, 10),
